...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0c] text-zinc-100 font-sans selection:bg-amber-500/30">
      ...
      {page === 'landing' ? (
        <LandingPage onStart={() => setPage('calculator')} />
      ) : (
        <div className="relative z-10 flex flex-col min-h-screen">
          ...
          {/* Footer */}
          <footer className="max-w-4xl mx-auto w-full px-6 py-12 border-t border-zinc-800 text-center text-white/50 text-sm font-light space-y-4">
