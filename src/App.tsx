...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0c] text-zinc-100 font-sans selection:bg-amber-500/30">
      ...
      {/* Footer */}
      <footer className="max-w-4xl mx-auto px-6 py-12 border-t border-zinc-800 text-center text-zinc-600 text-xs font-light">
        <p>&copy; {new Date().getFullYear()} Celestial Numerology. All calculations based on the Pythagorean system.</p>
        <p className="mt-2">For entertainment purposes only. The numbers guide, but you decide.</p>
      </footer>
    </div>
  );
}
